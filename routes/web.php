...
$routes = [
    ...
    'issuedDMStockRoom'         => 'modules/Stockroom/issuedDMStockroom.php',
    'issuedSuppliesStockRoom'   => 'modules/Stockroom/issuedSuppliesStockroom.php',
    // 'viewZBBLog'                => 'modules/Medical_Records/viewZBBLog.php',
    'viewZBBDashboard'          => 'modules/ZBB/viewZBBDashboard.php'
