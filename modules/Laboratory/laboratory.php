...
<div class="px-md-3">
    <div class="alert alert-warning alert-compact-left" role="alert">
        <p class="alert-heading">
            <b>NOTE:</b> This masterlist shows <b>laboratory requests</b> and their
...
<div class="px-md-3 mb-3">
    <form id="labFilterForm" class="row g-2 align-items-end">
        ...
        <div class="col-md-3 d-flex align-items-end">
            <a href="#" id="exportBtn" class="btn btn-success w-100">
...
<div class="px-md-1">
    <div class="table-container">
        ...
        <table id="labTable" class="table table-striped table-bordered nowrap" style="width:100%">
