...
function loadCSInventory($pdo)
{
    try {
        ...
        if (!empty($search)) {
            $where .= " AND (
                hc2.itemcode LIKE :search
                OR h2.cl2desc LIKE :search
                OR hc2.stockbal LIKE :search
                OR hc2.cl2retprc LIKE :search
                OR hc2.cl2dteas LIKE :search
                OR hc2.expiry LIKE :search
                OR hc2.cl2dtmd LIKE :search
